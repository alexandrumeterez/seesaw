...
export CONFIG=configs/kempner/base-c4-t5.yaml+configs/kempner/models/1.2b.yaml
export SWEEP_CONFIG=configs/kempner/sweeps/optimizers.yaml
...
# export CHECKPOINTS_PATH=/n/vast-scratch/kempner_fellows/opt-olmo/ckpts
