...
#SBATCH --output=/n/holyscratch01/barak_lab/Lab/opt-olmo/logs/%A_%a.log
#SBATCH --nodes=1              
...
export CONFIG=configs/kempner/base-c4-t5.yaml+configs/kempner/models/300m.yaml
export SWEEP_CONFIG=configs/kempner/sweeps/stableshampoo.yaml
